	...
	<div class="banner">
  	...
  	<div class="tab-content">
		...
		<div id="projects" data-tab-content >	
			...
			<?php 
				...
				{	
					...
					{
						if (!is_dir("projects/archive/$year"))
						{
							mkdir("projects/archive/$year", 0777, true);
							chmod("projects/archive/$year", 0777);
						}
						...
						{							
							...
							{
								if (!is_dir("projects/archive/$year/$month"))
								{
									mkdir("projects/archive/$year/$month", 0777, true);
									chmod("projects/archive/$year/$month", 0777);
								}
								...
								for ($day=31; $day>= 1; $day--) 
								{
									...
									{
										if (!is_dir("projects/archive/$year/$month/$day"))
										{
											mkdir("projects/archive/$year/$month/$day", 0777, true);
											chmod("projects/archive/$year/$month/$day", 0777);
										}
										...
										$tmplt = file_get_contents("projects/archive/template.php");
										$newfile = fopen("projects/archive/$year/$month/$day/$bname.php","w") or die("Unable to open file!");
										chmod("projects/archive/$year/$month/$day/$bname.php", 0777);
										...
										$line1 = fgets($f);
										fclose($f);
										echo("<button class='button-10' onclick= \"location.href='projects/archive/$year/$month/$day/$bname.php'\"><img src='projects/data/$year/$month/$day/thumbnail.jpg'  class='thumbnail'><br>$line1</button> ");
										echo("<br> <br>");
									}
								}
							}	
		...
		<div id="thoughts" data-tab-content>
			<h1>Thoughts</h1>
			<h4>This is where I'll post thoughts</h4>
			<?php 
							...
							if (is_dir("thoughts/data/$year/$month"))
							{
								...
								for ($day=31; $day>= 1; $day--) 
								{
									if (is_dir("thoughts/data/$year/$month/$day"))
									{
										...
										$line1 = fgets($f);
										fclose($f);
										echo("<button class='button-10' onclick= \"location.href='thoughts/archive/$year/$month/$day/$bname.php'\"><img src='thoughts/data/$year/$month/$day/thumbnail.jpg' class='thumbnail'><br>$line1</button> ");
										echo("<br> <br>");
									}
								}
							}	
